 ...
 */
void initInput(void) {
  palSetPadMode(RC1_PORT, RC1_PIN, PAL_MODE_INPUT) ;
  palSetPadMode(RC2_PORT, RC2_PIN, PAL_MODE_INPUT) ;
  palSetPadMode(RC3_PORT, RC3_PIN, PAL_MODE_INPUT) ;
  palSetPadMode(RC4_PORT, RC4_PIN, PAL_MODE_INPUT) ;
  palSetPadMode(RC5_PORT, RC5_PIN, PAL_MODE_INPUT) ;
  palSetPadMode(RC6_PORT, RC6_PIN, PAL_MODE_INPUT) ;
