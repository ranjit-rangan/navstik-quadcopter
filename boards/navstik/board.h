 ...
 * IO pins assignments.
 */
#define GPIOA_CS_SPI2           0      /* rrangan changed for NAVSTIK assignment. GPIOA_BUTTON            0 */ /* TODO - rrangan - It has been set to floating later on in the file - may need to pull it up ! */
#define GPIOA_LRCK              4
#define GPIOA_SPC               5
#define GPIOA_SDO               6
#define GPIOA_SDI               7
