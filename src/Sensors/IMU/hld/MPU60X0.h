 ...
 * contents of registers 59 through 96 will be written in order at the Sample Rate.
 */
 ...
 */
#define EXT_SYNC_SET0    0<<3  /* Disable Input. Use this in DAS since FSYNC pin is not used. */
